...
def process (img, frameType=0):
    ...
    plt.subplot(243),plt.imshow(img, cmap = 'gray')
    plt.subplot(244),plt.hist(img.ravel(),256,[0,256])
...
#         if fnd: 
#             cv.rectangle(img0,a,b,(255,0,0),2) 
#             break
...
while(True):
    ...
    for y in range(r):
        for x in range(c):
            ...
            print(y+1, x+1, (x1,y1,x2,y2), rat, tot, sec_area)
            if(rat> REQ_RAT):
                cv.rectangle(img0,(x1,y1),(x2,y2),(255,0,0),2)
